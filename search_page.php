...
<body>
    ...
    <section class="search-form">
        <form  method='post' >
            <input type="text" class="box" name="search_box" placeholder="pesquise no site">
            <input type="submit" name="search_btn" class="btn" value="Pesquisar">
        </form>
    </section>
    <?php
    ...
    <section class="products">
        ...
        <div class="box-container">
            ...
            <?php 
                    ...
                    echo ' <p class="empty">Sua pesquisa não encontrou resultados!</p> ';
                }
            ?>
        </div>
    </section>
